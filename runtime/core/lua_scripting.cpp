...
void dlua::init() {
	...
	sol::usertype<particleGenerator> particleGenerator_type = lua.new_usertype<particleGenerator>("particleGenerator", sol::constructors<particleGenerator(), particleGenerator(std::string, int, vec2d defaultSize, vec2d, float, vec2d)>());
	particleGenerator_type["toString"] = &particleGenerator::toString;

	particleGenerator_type["setTexture"] = &particleGenerator::setTexture;

	particleGenerator_type["pos"] = sol::property(&particleGenerator::setPos, &particleGenerator::getPos);
	particleGenerator_type["defaultSize"] = sol::property(&particleGenerator::setDefaultSize, &particleGenerator::getDefaultSize);
	particleGenerator_type["defaultVelocity"] = sol::property(&particleGenerator::setDefaultVelocity, &particleGenerator::getDefaultVelocity);
	particleGenerator_type["defaultLifetime"] = sol::property(&particleGenerator::getDefaultLifetime, &particleGenerator::setDefaultLifetime);
